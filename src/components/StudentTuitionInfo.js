...
const StudentTuitionInfo = ({ clientData }) => {
            ...
            <div className="col-lg-8 col-xl-9">
                ...
                <div class="tuition-tabs-container px-3 py-2">
                    <div class="tuition-tabs d-flex gap-2 overflow-auto flex-nowrap">
                        <button class="tab-btn active">Student Info 1</button>
                        <button class="tab-btn white">+ Add Student 2</button>
                        ...
                        <div className="tu-boxarea">
                            <div className="tu-boxsm">
                                <div className="tu-boxsmtitle">
                                    <h4>Apni jemon(pochonder) teacher khujchen</h4>
                                </div>
                            </div>
                                            ...
                                            <div className="form-group-wrap">
                                                ...
                                                <div className="form-group form-group-half">
                                                    ...
                                                    <div className="tu-select">
                                                        ...
                                                        >
                                                            <option label={"Select institute type"}></option>
                                                ...
                                                <div className="form-group form-group-half">
                                                    ...
                                                    <div className="tu-select">
                                                        ...
                                                        >
                                                            <option label={"Select institute name"}></option>
                                                            {divisionList?.length > 0 && divisionList.map((item, index) => (
                                                                <option key={index} value={item._id}>{item.divisionName}</option>
                                                            ))}
                                                        </select>
                                                ...
                                                <div className="form-group form-group-half">
                                                    ...
                                                    <div className="tu-select">
                                                        ...
                                                        >
                                                            <option label={"Select teacher gender"}></option>
                                                            {divisionList?.length > 0 && divisionList.map((item, index) => (
                                                                <option key={index} value={item._id}>{item.divisionName}</option>
                                                            ))}
                                                        </select>
                                                ...
                                                <div className="form-group form-group-half">
                                                    ...
                                                    <div className="tu-select">
                                                        ...
                                                        >
                                                            <option label={"Select teacher religion"}></option>
                                                            {divisionList?.length > 0 && divisionList.map((item, index) => (
                                                                <option key={index} value={item._id}>{item.divisionName}</option>
                                                            ))}
                                                        </select>
